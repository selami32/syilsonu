...
//    if (!genislik) genislik=850;
    ...
    var grid = new Ext.grid.EditorGridPanel({
       ...
       // autoExpandColumn: 'etkinlikturu',
        ...
        title:'Riskler ve Baþetme Becerileri Okul Projesi Yönetici-Öðretmen Eðitimi Programý  Deðerlendirme Sonuçlarý Tablosu (Eðitimler tamamlandýktan sonra aþaðýdaki tabloya Yönetici ve Öðretmenlere uygulanan Deðerlendirme Formlarýndan (Ek-2) elde edilen sayýsal verilerin toplamý girilecektir.)',
