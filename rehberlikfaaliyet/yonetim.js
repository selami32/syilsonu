...
transform:'okulcombo',lazyRender:true,width:85,listClass: 'x-combo-list-small'}) ;
    ...
    var grid = new Ext.grid.EditorGridPanel({
        ...
        colModel: new Ext.grid.ColumnModel({
         columns: [
            sm,
            {header: "Kurum kodu", id:'kurumkodu', width:65, sortable: true, dataIndex: 'kurumkodu', editor:  new Ext.form.NumberField({allowBlank: false,allowNegative: false, selectOnFocus:true, maxValue: 9999999999})},
       ...
       // autoExpandColumn: 'etkinlikturu',
        ...
        title:'Rehberlik Faaliyetleri okul yönetimi ve raporlama',
        listeners: {
      ...
      },
     {
            ...
            var record = grid.getSelectionModel().getSelected();
                ...
                var pencere= new window.top.Ext.Window({
                              ...
                              items : [{
                                  ...
                                  autoEl : {
                                      tag : "iframe",
                                       src : "formlar.php?kurumkodu="+kkurumkodu+"&ad="+adres
      ...
      ilcesicombo,
      {
            ...
            iconCls:'grid',
            handler : function(){
				document.location.href="rehberlik_tumrapor.php?ad="+adres+"&okulturu="+okulcombo.value+"&ilcesi="+ilcesicombo.value;
				return;
