...
/*renderer: change,*/
    ...
    var grid = new Ext.grid.EditorGridPanel({
        ...
        sm: sm,
        columns: [
            {id:'aciklama', header: "Öðrenci Görüþmelerinin Sorun Alanlarýna Göre Daðýlýmý", width: 290, dataIndex: 'aciklama' },
            {header: "Kýz", width: 55, sortable: false,  dataIndex: 'kizogrencisayisi', editor: new Ext.form.NumberField({allowBlank: false,allowNegative: false, selectOnFocus:true, maxValue: 100000})},
        ...
        width:550,
        clicksToEdit:1,        
        title:'Sorun Alanlarýnýn Deðerlendirilmesi:',
        listeners: {
