...
$sonuc = $veritabani->query($query) or die("Veri bulunamadi.");
    ...
    for($x = 0 ; $x< $sonuc->num_rows ; $x++)
    {
			...
			$output .= "['". 
			temizle($row['yasanansorun']) ."','" .
			temizle($row['sorunayonelikcalismalar']) ."','" .
			temizle($row['gerceklestirenkurum']) ."','" .
			intval($row['ogrencisayisi']) ."','".
			intval($row['annebabasayisi']) ."','".
			intval($row['personelsayisi']) ."'],\n";
...
<select name="gerceklestirenkurumcombo" id="gerceklestirenkurumcombo" style="display: none;">
<option value='Okul Müdürlükleri '>Okul Müdürlükleri </option>
<option value='Belediye - Okul Müdürlükleri'>Belediye - Okul Müdürlükleri</option>
<option value='Rehberlik ve Araştırma Merkezi- Okul Müdürlükleri'>Rehberlik ve Araştırma Merkezi- Okul Müdürlükleri</option>
<option value='Emniyet- Okul Müdürlükleri'>Emniyet- Okul Müdürlükleri</option>
<option value='Jandarma- Okul Müdürlükleri'>Jandarma- Okul Müdürlükleri</option>
<option value='Hastane- Okul Müdürlükleri'>Hastane- Okul Müdürlükleri</option>
<option value='Milli Eğitim- Okul Müdürlükleri'>Milli Eğitim- Okul Müdürlükleri</option>
<option value='Üniversite- Okul Müdürlükleri'>Üniversite- Okul Müdürlükleri</option>
<option value='Müftülük- Okul Müdürlükleri'>Müftülük- Okul Müdürlükleri</option>
<option value='Kaymakamlık- Okul Müdürlükleri'>Kaymakamlık- Okul Müdürlükleri</option>
<option value='Aile Sosyal Politikalar İl Müdürlükleri- Okul Müdürlükleri'>Aile Sosyal Politikalar İl Müdürlükleri- Okul Müdürlükleri</option>
<option value='Özel Okullar- Okul Müdürlükleri'>Özel Okullar- Okul Müdürlükleri</option>
<option value='Adliye- Okul Müdürlükleri'>Adliye- Okul Müdürlükleri</option>
<option value='Muhtarlık- Okul Müdürlükleri'>Muhtarlık- Okul Müdürlükleri</option>
<option value='Gençlik Merkezleri- Okul Müdürlükleri'>Gençlik Merkezleri- Okul Müdürlükleri</option>
<option value='Gençlik ve Spor İl/İlçe Müdürlükleri-Okul Müdürlükleri'>Gençlik ve Spor İl/İlçe Müdürlükleri-Okul Müdürlükleri</option>
</select>
