...
/*renderer: change,*/
    ...
    var grid = new Ext.grid.EditorGridPanel({
        ...
        columns: [
            {header: "Yaþanan sorunlar", id:'yasanansorunlar', width: 210, sortable: true, dataIndex: 'yasanansorunlar', editor:  secimler  },
            {header: "Çözüm önerileri", width: 190, sortable: true, dataIndex: 'cozumonerileri', editor: new Ext.form.TextField({ allowBlank: true })}
