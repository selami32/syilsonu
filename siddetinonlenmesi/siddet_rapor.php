...
$dosya="siddetprogram.xls";
$objReader = new PHPExcel_Reader_Excel5();
$obxl = $objReader->load($dosya);

include "sonucrapor/okullar.php";
include "sonucrapor/disiplinsuclari.php";
include "sonucrapor/siddetolaylari.php";
//include "sonucrapor/yasanansorunlar.php";
include "sonucrapor/bolgeselrisk.php";
include "sonucrapor/calismalar.php";
...
$indirilecekdosya="siddetrapor.xls";
