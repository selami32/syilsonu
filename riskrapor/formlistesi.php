...
$aciklama=array(
    "1- Yönetici-Öğretmen Eğitimi Programı Değerlendirme Sonuçları Tablosu",
    "2- Aile Eğitimi Programı Değerlendirme Sonuçları Tablosu",
    "3- Okul toplam öğrenci sayıları",
    "4- Riskler ve Başetme Becerileri Okul Projesi Değerlendirme Raporu"
);
