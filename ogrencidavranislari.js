...
var editcombo=new CustomComboBox({typeAhead: true, autocomplete: true, editable:true, triggerAction: 'all',transform:'davraniscombo',lazyRender:true,listClass: 'x-combo-list-small'}) ;
...
//    if (!genislik) genislik=850;
    ...
    var grid = new Ext.grid.EditorGridPanel({
       ...
       // autoExpandColumn: 'etkinlikturu',
        ...
        title:'Öðrenci Davranýþlarýnýn Deðerlendirilmesi',
