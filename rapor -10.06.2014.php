...
$sql="select `ilcesi`, `okulunadi`, `ogrenimsekli`, `ogrenimsekli`, `ogrencisayisikiz`, `ogrencisayisierkek`, `ogrencisayisitoplam`, `telefonfaks`,  `eposta`, `internetadresi`, `rehberogretmennorm`, `rehberogretmensayisi` from $tablo where kurumkodu=$kurumkodu";
$sorgu=$veritabani->query("$sql");
$degis="okul_bil";
...
if ($sorgu){
	...
	//          echo "burda $sonuc[$i] ";
		  ...
		  case 12:
				$degis="reh_d";            
				$content = preg_replace("'$degis'",($sonuc[10]-$sonuc[11]),$content,1); 
