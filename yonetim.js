    ...
    var grid = new Ext.grid.EditorGridPanel({
      ...
      },
     {
            ...
            var record = grid.getSelectionModel().getSelected();
                ...
                var pencere= new window.top.Ext.Window({
                              ...
                              items : [{
                                  ...
                                  autoEl : {
                                      tag : "iframe",
                                      src : "formlar.php?kurumkodu="+kkurumkodu
      ...
      ilcesicombo,
      {
            ...
            iconCls:'grid',
            handler : function(){
           //document.location.href="yilsonu_rapor.php";
                 delete pencere;
                var pencere=new Ext.Window({
                              title : 'Rapor Hazýrlanýyor...',
                              //applyto: "hello-win",
                              plain: true,
                              top : 0,
                              left: 0 ,
                              ...
                              items : [{
                                  ...
                                  autoEl : {
                                      tag : "iframe",
                                      src : "yilsonu_rapor.php?okulturu="+okulcombo.value+"&ilcesi="+ilcesicombo.value
