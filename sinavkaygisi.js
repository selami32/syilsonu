...
/*renderer: change,*/
    ...
    var grid = new Ext.grid.EditorGridPanel({
        ...
        sm: sm,
         columns: [
            {id:'calismakonusu', header: "Yapýlan Bilgilendirme Çalýþmalarýnýn Konusu", width: 290, dataIndex: 'calismakonusu' },
            ...
            {header: "Öðretmen sayýsý", width:70, sortable: false,  dataIndex: 'ogretmensayisi', editor: new Ext.form.NumberField({allowBlank: false,allowNegative: false, selectOnFocus:true, maxValue: 100000})},
        {header: "Aile sayýsý", width:70, sortable: false,  dataIndex: 'ailesayisi', editor: new Ext.form.NumberField({allowBlank: false,allowNegative: false, selectOnFocus:true, maxValue: 100000})},
        {header: "Mahalli basýn", width:70, sortable: false,  dataIndex: 'mahallibasin', editor: new Ext.form.NumberField({allowBlank: false,allowNegative: false, selectOnFocus:true, maxValue: 100000})}
        ],
        stripeRows: true,
       // autoExpandColumn: 'etkinlikturu',
        ...
        width:600,
        clicksToEdit:1,        
        title:'Sýnavlar ve Sýnav Kaygýsýna Yönelik Çalýþmalar:',
        tbar: [{        
            text: 'Kaydet',
            iconCls:'save',
            handler : function(){
